...
export const colors = {
	light: {
		...
		overlayLight: getRgba(colorPalette.neutral[950], 0.3),
		overlayMedium: getRgba(colorPalette.neutral[950], 0.5),
		overlayDark: getRgba(colorPalette.neutral[950], 0.7),
